...
const NatTutorial = () => {
  ...
  return (
    <div ref={sectionRef} className="max-w-4xl mx-auto px-4 py-10 text-gray-800 leading-relaxed">
      ...
      <div data-animate style={{ opacity: 0, transform: 'translateY(30px)' }}>
        <h1 className="text-3xl font-bold mb-4">Network Address Translation NAT Tutorial</h1>
      </div>
  ...
  <p>The noticeable downtime can be reduced significantly if we use Rapid Spanning Tree Protocol (RSTP). If you are interested in RSTP, please read my <a href="https://www.9tut.com/rapid-spanning-tree-protocol-rstp-tutorial" target="_blank" rel="noopener noreferrer">Rapid Spanning Tree Protocol Tutorial</a>.</p>
</div>
